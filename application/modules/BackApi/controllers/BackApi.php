        ...
        if (curl_errno($ch)) {
            ...
            if ($dataCek->total > 0) {
                ...
                if ($httpCode == 200) {
                    ...
                    $dataArr = array('message' => "Berhasil Update", 'status' => 1, 'Nik' => $NIK, 'url'=> $url, 'ValReturn' => $dataCek, 'access_token' => $dataAccess);
                    ...
                    $this->db->insert('SatuSehat.Log_Token', $dataToken);
                    $dataArr = array('message' => "Gagal Response", 'status' => 0, 'Nik' => $NIK, 'url'=> $url, 'ValReturn' => $dataCek, 'access_token' => $dataAccess);
            
                }
            } else {
                $dataArr = array('message' => "Data Tidak Ditemukan",'status' => 0, 'Nik' => $NIK, 'url'=> $url, 'ValReturn' => $dataCek, 'access_token' => $dataAccess);
                $dataToken = array(
                    'NoTrx' => uniqid(true).date("Y_m_d"),
                    'access_token' => $dataCek->access_token,
                    'client_id' => $dataCek->client_id,
        ...
        if (curl_errno($ch)) {
            ...
            if ($dataCek->total > 0) {
                ...
                if ($httpCode == 200) {
                    // Decode and handle the response
                    $dataCek = json_decode($response);
                    $dataArr = array('message' => "Data Berhasil Di Update", 'status' => 1,'ValReturn' => $dataCek, 'access_token' => $dataAccess);
                    ...
                    // Handle non-200 status code
                    // echo "HTTP Error: $httpCode\n";
                    $dataArr = array('message' => "Data Gagal Di Update", 'status' => 0,'ValReturn' => $dataCek, 'access_token' => $dataAccess);
                    echo json_encode($dataArr);
                    // echo "Response: $response\n";
                    $dataToken = array(
                        'NoTrx' => uniqid(true).date("Y_m_d"),
                ...
                $dataArr = array('message' => "Data Tidak Ditemukan",'status' => 0,'ValReturn' => $dataCek, 'access_token' => $dataAccess);
                    echo json_encode($dataArr);
                    // echo "Response: $response\n";
                    $dataToken = array(
                        'NoTrx' => uniqid(true).date("Y_m_d"),
